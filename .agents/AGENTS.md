...
- When writing a PR description:
  ...
  - Give a top level list of "Changes" in bullet points to summarize the PR.
  - Add a collapsible table showing every file change, and a very short description of how it was changed.
